...
export default function LazyMint(props) {
  ...
  React.useEffect(() => {
    ...
    if(queries.tokenURI !== undefined){
      setErc721IpfsHash(queries.tokenURI.split("ipfs://")[1]);
      setErc1155IpfsHash(queries.tokenURI.split("ipfs://")[1]);
    }
  }, []);
      ...
      >
        Mint
                      ...
                      <Card
                        title={
                          <div>
                            <span style={{ fontSize: 12, marginRight: 8 }}>Token ID: {erc721TokenId}</span>
                          </div>
                        }
                      >
                        {/* <div>
      ...
      >
        Mint
                      ...
                      <Card
                        title={
                          <div>
                            <span style={{ fontSize: 12, marginRight: 8 }}>Token ID: {erc1155TokenId}</span>
                          </div>
                        }
                      >
                        {/* <div>
